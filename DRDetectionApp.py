...
model = keras.models.load_model(r'D:\ML\Prepro94.75')
...
#Images
NU = Image.open(r"D:\Downloads\NULOGO-Download-EN.png")
SCI = Image.open(r"D:\Downloads\logo-sci-01.webp")
IMAGES = [NU,SCI]
DRex = Image.open(r"D:\Downloads\Exeter-Eye-Diabetic-Retinopathy-eye-diagram.jpg")
DRprepro = Image.open(r"D:\ML\PreproEX.png")
